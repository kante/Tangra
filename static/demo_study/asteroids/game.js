...
// Stuff for submitting to the tangra server
...
Game = {
  ...
  FSM: {
    ...
    end_game: function () {
      ...
      // wait 1 seconds then save the data on the tangra server
      if (Date.now() - this.timer > 1000) {
        this.timer = null;
        this.state = 'saving_data';
      }
...
// Tangra hacks to save data. 
var saving_data_now = false;
var paused = false;
